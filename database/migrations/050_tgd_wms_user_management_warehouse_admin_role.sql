-- 050_tgd_wms_user_management_warehouse_admin_role.sql
-- Allow warehouse_admin in admin user-management RPC after migration 049.
...
comment on function public.tgd_admin_upsert_user_profile(uuid, text, text, text, uuid, uuid, boolean) is
  'USER-MGMT-050: Admin-only profile create/update including warehouse_admin role.';
