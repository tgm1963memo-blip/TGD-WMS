-- Migration 058: Add CONFIRM_RECEIPT support to tgd_review_customer_deposit_request
-- Allows admins/warehouse staff to mark a WAREHOUSE_RECEIVING deposit as RECEIVED_CONFIRMED.
-- Also adds warehouse_manager and warehouse_admin roles to the confirm action.
