-- Prepared Stock Balance Trigger Design – DO NOT APPLY TO PRODUCTION WITHOUT CONTROLLER APPROVAL
...
RETURNS trigger AS $$
BEGIN
    -- UPSERT into the balance table (customer, product, lot, location) adding the movement quantity
...
-- End of Stock Balance Trigger Design
