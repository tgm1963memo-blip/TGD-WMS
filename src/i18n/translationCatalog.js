...
Object.assign(TRANSLATION_CATALOG, {
  ...
  user_mgmt_description: { th: 'แอดมินสร้าง/แก้ไขโปรไฟล์ผู้ใช้และเชื่อมลูกค้า — ไม่สร้างบัญชี Auth อัตโนมัติ', en: 'Admin creates/updates user profiles and customer links. Does not create Supabase Auth users automatically.' },
  user_mgmt_admin_only: { th: 'เฉพาะผู้ใช้ role admin', en: 'Admin role required.' },
  user_mgmt_auth_note: { th: 'ขั้นตอน: 1) สร้างผู้ใช้ใน Supabase Auth 2) สร้าง/แก้ไขโปรไฟล์ที่นี่ 3) วาง auth_user_id (UUID) เพื่อเชื่อมการล็อกอิน', en: 'Workflow: 1) Create user in Supabase Auth 2) Create/edit profile here 3) Paste auth_user_id UUID to link login.' },
