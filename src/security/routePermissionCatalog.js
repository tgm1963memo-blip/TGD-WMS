...
export const ROUTE_PERMISSION_CATALOG = [
  ...
  { route_path: '/customer/admin/deposit-review/:requestId', route_name: 'CustomerAdminDepositReviewPage', permission_area: 'customer_portal', minimum_role: 'warehouse_staff', access_level: 'read', notes: 'Warehouse review of a specific customer deposit request' },
