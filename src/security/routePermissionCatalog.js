...
export const ROUTE_PERMISSION_CATALOG = [
  ...
  { route_path: '/customer', route_name: 'CustomerPortalDashboardPage', permission_area: 'customer_portal', minimum_role: 'customer_user', access_level: 'read', notes: '', menu_key: 'customer_portal_home' },
  { route_path: '/customer/deposit-request', route_name: 'CustomerDepositRequestPage', permission_area: 'customer_portal', minimum_role: 'customer_user', access_level: 'read', notes: '', menu_key: 'customer_deposit_request' },
  { route_path: '/customer/deposit-request/new', route_name: 'CustomerDepositRequestCreatePage', permission_area: 'customer_portal', minimum_role: 'customer_user', access_level: 'write', notes: '', menu_key: 'customer_deposit_request' },
  { route_path: '/customer/deposit-request/:requestId', route_name: 'CustomerDepositRequestDetailPage', permission_area: 'customer_portal', minimum_role: 'customer_user', access_level: 'read', notes: '', menu_key: 'customer_deposit_request' },
  { route_path: '/customer/stock-balance', route_name: 'CustomerStockBalancePage', permission_area: 'customer_portal', minimum_role: 'customer_user', access_level: 'read', notes: '', menu_key: 'customer_stock_balance' },
  { route_path: '/customer/withdrawal-request', route_name: 'CustomerWithdrawalRequestPage', permission_area: 'customer_portal', minimum_role: 'customer_user', access_level: 'read', notes: '', menu_key: 'customer_withdrawal_request' },
  { route_path: '/customer/withdrawal-request/new', route_name: 'CustomerWithdrawalRequestCreatePage', permission_area: 'customer_portal', minimum_role: 'customer_user', access_level: 'write', notes: '', menu_key: 'customer_withdrawal_request' },
  { route_path: '/customer/withdrawal-request/:requestId', route_name: 'CustomerWithdrawalRequestDetailPage', permission_area: 'customer_portal', minimum_role: 'customer_user', access_level: 'read', notes: '', menu_key: 'customer_withdrawal_request' },
  { route_path: '/customer/requests', route_name: 'CustomerRequestHistoryPage', permission_area: 'customer_portal', minimum_role: 'customer_user', access_level: 'read', notes: '', menu_key: 'customer_request_history' },
  { route_path: '/customer/facility-usage', route_name: 'CustomerFacilityUsageRequestPage', permission_area: 'customer_portal', minimum_role: 'customer_user', access_level: 'write', notes: '', menu_key: 'customer_facility_usage' },
  { route_path: '/customer/product-catalog', route_name: 'CustomerProductCatalogPage', permission_area: 'customer_portal', minimum_role: 'customer_user', access_level: 'write', notes: '', menu_key: 'customer_product_catalog' },
  { route_path: '/customer/movement-ledger', route_name: 'CustomerMovementLedgerPage', permission_area: 'customer_portal', minimum_role: 'customer_user', access_level: 'read', notes: '', menu_key: 'customer_movement_ledger' },
  { route_path: '/customer/team-roles', route_name: 'CustomerTeamRolesPage', permission_area: 'customer_portal', minimum_role: 'customer_admin', access_level: 'admin', notes: 'customer_admin manages custom roles for their own company\'s customer_user accounts' },
